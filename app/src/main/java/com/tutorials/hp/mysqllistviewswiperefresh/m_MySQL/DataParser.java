...
import com.tutorials.hp.mysqllistviewswiperefresh.m_DataObject.Spacecraft;
import com.tutorials.hp.mysqllistviewswiperefresh.m_UI.CustomAdapter;
...
public class DataParser extends AsyncTask<Void,Void,Boolean> {
    ...
    protected void onPostExecute(Boolean isParsed) {
        ...
        {
            //BIND
            lv.setAdapter(new CustomAdapter(c,spacecrafts));
